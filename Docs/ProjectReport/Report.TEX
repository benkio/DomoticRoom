...
\newcommand{\xauthA}{Enrico Benini}
\newcommand{\xauthB}{Nicola Casadei}
\newcommand{\xauthC}{Marco Benedetti}
...
\title{Smart City -- Project report}
...
\institute {  \xunibo\\\xaddrCE, \xcityCE\\\email{\{enrico.benini5, nicola.casadei4, marco.benedetti7\}@studio.unibo.it}}
...
\input{8a_Hardware_Configuration.tex}
